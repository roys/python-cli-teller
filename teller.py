...
def getAccountData():
    ...
    response = requests.get('https://publicapi.sbanken.no/apibeta/api/v1/accounts', headers=headers)
...
def printTransactions():
    ...
    # print account
    response = requests.get('https://publicapi.sbanken.no/apibeta/api/v1/transactions/' + account['accountId'], headers=headers, params=params)
    if response.status_code == 200:
...
def doTransfer():
    ...
    response = requests.post('https://publicapi.sbanken.no/apibeta/api/v1/transfers', headers=headers, data=json.dumps(transfer))
